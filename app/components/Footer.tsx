...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#183B4E] text-white py-12 px-4 sm:px-8 md:px-16 lg:px-24">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        <h3 className="font-montserrat font-semibold text-lg mb-4 text-[#F5EEDC]">Pautan Pantas</h3>
                        <nav>
                            <ul className="space-y-2 font-montserrat">
                                <li>
                                    <Link href="#gallery" className="text-white/80 hover:text-white text-sm transition-colors duration-300">
                                        Galeri
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#facilities" className="text-white/80 hover:text-white text-sm transition-colors duration-300">
                                        Kemudahan
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#location" className="text-white/80 hover:text-white text-sm transition-colors duration-300">
                                        Lokasi
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#nearby" className="text-white/80 hover:text-white text-sm transition-colors duration-300">
                                        Kawasan Sekitar
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#faq" className="text-white/80 hover:text-white text-sm transition-colors duration-300">
                                        Soalan Lazim
                                    </Link>
                                </li>
                            </ul>
                    ...
                    {/* Column 3: Contact */}
                    <div>
                        <h3 className="font-montserrat font-semibold text-lg mb-4 text-[#F5EEDC]">Hubungi Kami</h3>
                        <div className="space-y-3">
                            <div className="flex items-start space-x-3">
                                <div className="text-[#DDA853] mt-1">
