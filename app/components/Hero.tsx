                ...
                <div className="flex flex-col justify-center w-full max-w-xl py-12 md:py-20">
                    ...
                    <div className="flex gap-4 mt-6 sm:mt-8">
                        <Link
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group p-3 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all duration-300 hover:translate-y-[-2px] active:translate-y-0"
                            aria-label="Facebook"
                        >
                            <svg className="w-5 h-5 text-white group-hover:text-[#DDA853] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
