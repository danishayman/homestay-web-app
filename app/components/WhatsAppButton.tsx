...
export default function WhatsAppButton() {
  ...
  return (
    <Link
      ...
      className={`fixed bottom-6 left-6 z-50 bg-[#25D366] text-white rounded-full p-3 shadow-lg transform transition-all duration-300 hover:scale-110 ${
    ...
    >
      <div className="relative">
        ...
        {/* Pulse effect */}
        <span className="absolute -inset-0.5 rounded-full animate-pulse bg-[#25D366]/50"></span>
      </div>
    </Link>
  );
} 